...
const schema = Yup.object().shape({
    ...
    RCNumbers: Yup.string()
        .required("RC Numbers is Required"),
    ...
    TargetHard: Yup.string()
        .required("Target hard capital is Required"),
    TargetSoft: Yup.string()
        .required("Target soft capital is Required"),
    ...
    Identification: Yup.string()
        .required("Means of ID is Required"),
    Phone: Yup.string()
...
const Listing = ({theme, action}) => {
    ...
    return (
        ...
        <View style={{
            flex: 1,
            backgroundColor: theme === 'Dark' ? DarkColors.primaryDarkThree : '#eee'
        }}>
                        ...
                        <AnimatePresence exitBeforeEnter>
                            {
                                ...
                                <Wrap key="firstForm">
                                    ...
                                    <View style={{paddingHorizontal: 32, marginBottom: 1, width: '100%'}}>
                                        <TouchableOpacity onPress={getPitch} style={{
                                            width: 140,
                                            height: 45,
                                            ...
                                            <FontAwesome5 name="file-upload" size={18}
                                                          color={theme === 'Dark' ? '#eee' : '#333'}/>
                                        </TouchableOpacity>
                                    </View>
                                    <Text style={styles.errorText} numberOfLines={1}>
                                            ...
                                            <Picker
                                                ...
                                                }>
                                                {
                                                    Countries.map((country, index) => (
                                                        <Picker.Item label={country.title} value={country.value}
                                                                     key={index}/>
                                                    ))
                                                }
                                    ...
                                    <View style={{paddingHorizontal: 32, width: '100%',}}>
                                        ...
                                        <TouchableOpacity activeOpacity={0.7} onPress={showDatepicker} style={{
                                            width: 160,
                                            height: 45,
                                        ...
                                        <Text style={{
                                            ...
                                            fontFamily: 'Gordita-bold',
                                            color: theme === 'Dark' ? '#eee' : '#333',
                                        }}>{date ? date.toDateString() : "Select date..."}</Text>
...

                            {
                                ...
                                <Wrap key='secondForm'>
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={getCAC} style={{
                                            width: 140,
                                            height: 45,
                                            borderColor: DayColors.cream,
                                            borderWidth: 2,
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={getID} style={{
                                            width: 150,
                                            height: 45,
                    ...
                    <TouchableOpacity onPress={toggle} style={{
                        ...
                        <Text style={{
                        ...
                        }}>
                            {
                                visible ?
                                    (
                                        <>Next <FontAwesome5 name="chevron-right" size={14} color="black"/></>
                                    ) :
                                    (
                                        <>Prev <FontAwesome5 name="chevron-left" size={14} color="black"/></>
                                    )}
                        </Text>
                    </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    errorText: {
        paddingHorizontal: 32, fontSize: 10, alignItems: "flex-start", width: '75%', color: '#FF5A5F', padding: 2
    }
